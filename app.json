{
  "name": "𝕿𝖎𝖙𝖆𝖓 𝖚𝖘𝖊𝖗𝖇𝖔𝖙",
  "description": "The fucking Titan Userbot is ready to be deployed........ Join our support @THETITANS_USERBOT",
  "logo": "https://telegra.ph/file/e0f4398b3637174e9686f.jpg",
    "keywords": [
    "telegram",
    "userbot",
    "plugin",
  ...
  "repository": "https://github.com/TitanNetworks/The-Titans-Userbot/",
  "website": "https://github.com/TitanNetworks/The-Titans-Userbot/",
  "success_url": "https://t.me/THETITANS_USERBOT",
  "env": {
    "ENV": {
    ...
    "ALIVE_NAME": {
      "description": "Fill your Full name. By default it is AuraX User",
      "value": "Titan User",
      "required": false
    },
    "ALIVE_MSG": {
      "description": "Set Custom Alive Message When entering .alive Command.",
      "value": "I am Titan Bot user",
      "required": false
    },
    "ALIVE_PIC": {
      "description": "Put here any telegraph media link for alive pic in .alive command.",
      "value": "alive_gif.mp4",
      "required": false
    },
    "BIO_MSG": {
      "description": "Put Your Telegram Bio Here Required For Auto Bio.",
      "value": "I am your daddy because I use Titan Userbot",
      "required": false
    },
    "PMPERMIT_PIC": {
      "description": "put here any telegraph media link for custom pmpermit pic.",
      "value": "https://telegra.ph/file/19394b52001265d943584.mp4",
      "required": true
    },
    "CUSTOM_PMPERMIT": {
      "description": "Enter Your custom pm permit msg.",
      "value": "PLEASE DO NOT SPAM IN MY DM, OTHERWISE YOU WILL BLOCKED AND GIVEN FED BAN IN TITANS FEDERATION. I WILL REPLY YOU AFTER COME BACK ONLINE!",
      "required": false
    },
    "PM_PERMIT_GROUP_ID": {
    ...
    "STRING_SESSION": {
      "description": "Get this value by running https://repl.it/itzgauravv/AuraXBot#main.py ",
      "value": ""
    },
    "HEROKU_API_KEY": {
      "description": "Go to https://dashboard.heroku.com/account, scroll down and press Reveal API.Required for updater to work.",
      "value": "a79b4824-ae30-4037-bbd5-da263c24be15",
      "required": true
    },
    "HEROKU_APP_NAME": {
    ...
    "TG_BOT_TOKEN_BF_HER": {
      ...
      "value": "1804772592:AAE53HSvf7p-L9eeu5Sqpg3uO72LQuEyjQ4"
    },
    "CHROME_BIN": {
    ...
    "NO_OF_BUTTONS_DISPLAYED_IN_H_ME_CMD": {
      "description": " Set The Amount Of Buttons Displayed In Help Command default 8",
      "value": "8",
      "required": true
    },
