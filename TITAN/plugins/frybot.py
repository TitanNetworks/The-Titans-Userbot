# ©TitanNetwork 2021-22
# If you gonna kang these,then keep credits 
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the AuraX out of it
