...
from TITAN.events import register
    ...
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        if LOGGER:
            await e.client.send_message(
                LOGGER_GROUP,
                "#SPAM \n\n"
                "Spam was executed successfully by your TitanBot"
                )
    ...
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        if LOGGER:
            await e.client.send_message(
                LOGGER_GROUP,
                "#BIGSPAM \n\n"
                "Bigspam was executed successfully by your TitanBot"
                )
    ...
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        if LOGGER:
            await e.client.send_message(
                LOGGER_GROUP,
                "#PICSPAM \n\n"
                "PicSpam was executed successfully by your TitanBot"
                )
