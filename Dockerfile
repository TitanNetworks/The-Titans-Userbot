# shifted this code to kali linux from alpine
# Copyright@2021 by TitansNetwork
# Coded by @Ranger_nex_op
# Kangers gaand mar dunga loveday
...
RUN git clone https://github.com/TitanNetworks/The-Titans_Userbot/root/userbot
RUN mkdir /root/TITAN/bin/
WORKDIR /root/TITAN/
RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
CMD ["bash","./TITAN/start.sh"]
